// CareersPage.tsx with video hero and ShadCN UI components
          ...
          {[
            {
              ...
              description: 'Seeking a skilled React developer to build intuitive user interfaces.',
            },
            {
              title: 'Backend Developer',
              location: 'Battaramulla, Sri Lanka',
              description: 'Looking for an experienced Node.js developer to manage server-side logic.',
            },
            {
              title: 'UI/UX Designer',
              location: 'Remote',
              description: 'Creative designer needed to craft engaging user experiences.',
            },
            {
              title: 'Digital Marketing Specialist',
              location: 'Melbourne, Australia',
              description: 'Expert in SEO and SEM strategies to enhance our online presence.',
            },
          ].map((job, idx) => (
